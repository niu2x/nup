...
execute_process(
  COMMAND "/usr/bin/git" show-ref 1.71.0
  WORKING_DIRECTORY "/home/niu2x/project/nup/build-android/boost-prefix/src/boost"
...
if("${show_ref_output}" MATCHES "refs/remotes/1.71.0")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "1.71.0")
...
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 1.71.0
  WORKING_DIRECTORY "/home/niu2x/project/nup/build-android/boost-prefix/src/boost"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://gitee.com/add358/boost'")
  endif()
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/niu2x/project/nup/build-android/boost-prefix/src/boost/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/niu2x/project/nup/build-android/boost-prefix/src/boost/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
