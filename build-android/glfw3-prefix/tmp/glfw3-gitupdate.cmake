...
if("${show_ref_output}" MATCHES "refs/remotes/3.3.8")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "3.3.8")
...
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 3.3.8
  WORKING_DIRECTORY "/home/niu2x/project/nup/build-android/glfw3-prefix/src/glfw3"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/niu2x/project/nup/build-android/glfw3-prefix/src/glfw3/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/niu2x/project/nup/build-android/glfw3-prefix/src/glfw3/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
